...
import DownloadSketch from '../components/download/DownloadSketch.jsx'
...
```js
<link rel="stylesheet" href="https://s3.eu-central-1.amazonaws.com/com.zeppelin.zds.assets/zel/css/zeppelin-element-library.css" integrity="XXX" crossorigin="anonymous">
