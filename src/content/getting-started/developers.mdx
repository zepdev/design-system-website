...
<List style={{ marginBottom: 30 }} variant="attribute">
  ...
  <ListItem label="@zlab-de/zel-react">
    A <Link to='/content/zel-react/getting-started'>React component library</Link>  build using the zeppelin-element-library
  </ListItem>
  <ListItem label="@zlab-de/zel-vue">
    A <Link to='/content/zel-vue/getting-started'>Vue component library</Link>  build using the zeppelin-element-library
  </ListItem>
</List>
...
### 1) zel.css
The basic css to create any Zeppelin Design System component. For all examples, please check out the elements, Zel-React, or Zel-Vue sections. 
