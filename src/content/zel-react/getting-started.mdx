...
export default function App() {
  return (
    <div className="theme-zeppelin">
      <h1>Hello World!</h1>
      <p style={{color: guidelines.color.corporate.indigo}}>Zeppelin colored text!</p>
    </div>
  );
}
```
